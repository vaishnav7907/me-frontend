...
const NewArrivalsGrid = () => {
  ...
  const getLatestArrivals = async () => {
    try {
      ...
      console.log(
        "latest arrivals",
        latestArrivalsApi.data.products,
      );
    } catch (error) {
              ...
              <div className="relative aspect-[4/4.7] overflow-hidden bg-[#151719]">
                {productImage ? (
                  ...
                  <div className="flex h-full w-full items-center justify-center">
                    <FiPackage className="text-4xl text-[#33373c]" />
                  </div>
                )}
                  ...
                  <span
                    className={`rounded-full border px-2.5 py-1 text-[9px] backdrop-blur-md ${
                      productStatus === "In Stock"
                        ? "border-green-400/10 bg-green-400/[0.08] text-green-400"
              ...
              <div className="p-4">
                {productData.brand && (
                  <div className="mb-3 flex items-center gap-2">
                    <div className="flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-md border border-white/[0.08] bg-white">
                    ...
                    <p className="truncate text-[10px] font-medium uppercase tracking-[0.18em] text-[#8b9198]">
                      {productData.brand.brandName}
                    </p>
                  </div>
                )}
                ...
                <div className="mt-4 border-b border-white/[0.06] pb-4">
                  <div className="flex flex-wrap gap-2">
                    ...
                    <span className="rounded-md border border-[#25282d] bg-[#111316] px-2.5 py-1.5 text-[9px] text-[#686e75]">
                      {productData.brand?.brandName || "No Brand"}
                    </span>
